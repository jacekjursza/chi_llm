...
from chi_llm.core import MicroLLM, quick_llm, MODEL_FILE, MODEL_REPO, MODEL_DIR
...
class TestMicroLLM:
    ...
    def test_ask(self, mock_download, mock_llama):
        ...
        mock_llama_instance = Mock()
        mock_llama_instance.return_value = {
            'choices': [{'text': 'Answer to question'}]
        }
        mock_llama.return_value = mock_llama_instance
